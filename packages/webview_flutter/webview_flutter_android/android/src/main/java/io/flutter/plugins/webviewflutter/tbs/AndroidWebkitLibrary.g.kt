...
private class AndroidWebkitLibraryPigeonInstanceManagerApi(val binaryMessenger: BinaryMessenger) {
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, instanceManager: AndroidWebkitLibraryPigeonInstanceManager?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.PigeonInternalInstanceManager.removeStrongReference", codec)
        if (instanceManager != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> = try {
              ...
              io.flutter.plugins.webviewflutter.tbs.wrapError(exception)
            }
            reply.reply(wrapped)
          }
        } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.PigeonInternalInstanceManager.clear", codec)
        if (instanceManager != null) {
...
{
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.PigeonInternalInstanceManager.removeStrongReference"
    ...
    channel.send(listOf(identifierArg)) {
      if (it is List<*>) {
        ...
        callback(Result.failure(
          io.flutter.plugins.webviewflutter.tbs.createConnectionError(
            channelName
          )
        ))
      } 
...
abstract class AndroidWebkitLibraryPigeonProxyApiRegistrar(val binaryMessenger: BinaryMessenger) {
  ...
  init {
    ...
    instanceManager = io.flutter.plugins.webviewflutter.tbs.AndroidWebkitLibraryPigeonInstanceManager.create(
  ...
  fun setUp() {
    io.flutter.plugins.webviewflutter.tbs.AndroidWebkitLibraryPigeonInstanceManagerApi.setUpMessageHandlers(binaryMessenger, instanceManager)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiCookieManager.setUpMessageHandlers(binaryMessenger, getPigeonApiCookieManager())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebView.setUpMessageHandlers(binaryMessenger, getPigeonApiWebView())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebSettings.setUpMessageHandlers(binaryMessenger, getPigeonApiWebSettings())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiJavaScriptChannel.setUpMessageHandlers(binaryMessenger, getPigeonApiJavaScriptChannel())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebViewClient.setUpMessageHandlers(binaryMessenger, getPigeonApiWebViewClient())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiDownloadListener.setUpMessageHandlers(binaryMessenger, getPigeonApiDownloadListener())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebChromeClient.setUpMessageHandlers(binaryMessenger, getPigeonApiWebChromeClient())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiFlutterAssetManager.setUpMessageHandlers(binaryMessenger, getPigeonApiFlutterAssetManager())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebStorage.setUpMessageHandlers(binaryMessenger, getPigeonApiWebStorage())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiPermissionRequest.setUpMessageHandlers(binaryMessenger, getPigeonApiPermissionRequest())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiCustomViewCallback.setUpMessageHandlers(binaryMessenger, getPigeonApiCustomViewCallback())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiView.setUpMessageHandlers(binaryMessenger, getPigeonApiView())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiGeolocationPermissionsCallback.setUpMessageHandlers(binaryMessenger, getPigeonApiGeolocationPermissionsCallback())
    io.flutter.plugins.webviewflutter.tbs.PigeonApiHttpAuthHandler.setUpMessageHandlers(binaryMessenger, getPigeonApiHttpAuthHandler())
  }
  fun tearDown() {
    io.flutter.plugins.webviewflutter.tbs.AndroidWebkitLibraryPigeonInstanceManagerApi.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiCookieManager.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebView.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebSettings.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiJavaScriptChannel.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebViewClient.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiDownloadListener.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebChromeClient.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiFlutterAssetManager.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiWebStorage.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiPermissionRequest.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiCustomViewCallback.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiView.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiGeolocationPermissionsCallback.setUpMessageHandlers(binaryMessenger, null)
    io.flutter.plugins.webviewflutter.tbs.PigeonApiHttpAuthHandler.setUpMessageHandlers(binaryMessenger, null)
  }
}
private class AndroidWebkitLibraryPigeonProxyApiBaseCodec(val registrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) : AndroidWebkitLibraryPigeonCodec() {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?) {
    if (value is Boolean || value is ByteArray || value is Double || value is DoubleArray || value is FloatArray || value is Int || value is IntArray || value is List<*> || value is Long || value is LongArray || value is Map<*, *> || value is String || value is FileChooserMode || value is ConsoleMessageLevel || value == null) {
    ...
    if (value is com.tencent.smtt.export.external.interfaces.WebResourceRequest) {
     ...
     else if (value is io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl) {
      registrar.getPigeonApiWebChromeClient().pigeon_newInstance(value) { }
    }
     else if (value is io.flutter.plugins.webviewflutter.tbs.FlutterAssetManager) {
    ...
    return when (type) {
      129.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
          io.flutter.plugins.webviewflutter.tbs.FileChooserMode.ofRaw(it.toInt())
        }
      }
      130.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
          io.flutter.plugins.webviewflutter.tbs.ConsoleMessageLevel.ofRaw(it.toInt())
        }
      }
      else -> super.readValueOfType(type, buffer)
    }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.export.external.interfaces.WebResourceRequest, callback: (Result<Unit>) -> Unit)
{
    ...
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebResourceRequest.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.export.external.interfaces.WebResourceResponse, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebResourceResponse.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.export.external.interfaces.WebResourceError, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebResourceError.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun pigeon_newInstance(pigeon_instanceArg: androidx.webkit.WebResourceErrorCompat, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebResourceErrorCompat.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg, errorCodeArg, descriptionArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun pigeon_newInstance(pigeon_instanceArg: WebViewPoint, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewPoint.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.export.external.interfaces.ConsoleMessage, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.ConsoleMessage.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiCookieManager(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiCookieManager?) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.CookieManager.instance", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.CookieManager.setCookie", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.CookieManager.removeAllCookies", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.CookieManager
            api.removeAllCookies(pigeon_instanceArg) { result: Result<Boolean> ->
              ...
              if (error != null) {
                ...
                reply.reply(io.flutter.plugins.webviewflutter.tbs.wrapResult(data))
              }
            }
          }
        } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.CookieManager.setAcceptThirdPartyCookies", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.CookieManager
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.sdk.CookieManager, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.CookieManager.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiWebView(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  abstract fun setWebChromeClient(pigeon_instance: com.tencent.smtt.sdk.WebView, client: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl?)
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiWebView?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.settings", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.loadData", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.loadDataWithBaseUrl", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.loadUrl", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.postUrl", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.getUrl", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.canGoBack", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.canGoForward", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.goBack", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.goForward", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.reload", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.clearCache", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.evaluateJavascript", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.getTitle", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.setWebContentsDebuggingEnabled", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.setWebViewClient", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.addJavaScriptChannel", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.removeJavaScriptChannel", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.setDownloadListener", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.setWebChromeClient", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
            val clientArg = args[1] as io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl?
            val wrapped: List<Any?> = try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.setBackgroundColor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.destroy", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebView
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.sdk.WebView, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onScrollChanged(pigeon_instanceArg: com.tencent.smtt.sdk.WebView, leftArg: Long, topArg: Long, oldLeftArg: Long, oldTopArg: Long, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebView.onScrollChanged"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiWebSettings(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiWebSettings?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setDomStorageEnabled", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setJavaScriptCanOpenWindowsAutomatically", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setSupportMultipleWindows", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setJavaScriptEnabled", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setUserAgentString", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setMediaPlaybackRequiresUserGesture", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setSupportZoom", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setLoadWithOverviewMode", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setUseWideViewPort", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setDisplayZoomControls", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setBuiltInZoomControls", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setAllowFileAccess", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.setTextZoom", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.getUserAgentString", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.sdk.WebSettings
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.sdk.WebSettings, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebSettings.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
...
abstract class PigeonApiJavaScriptChannel(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiJavaScriptChannel?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.JavaScriptChannel.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
  ...
  fun postMessage(pigeon_instanceArg: JavaScriptChannel, messageArg: String, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.JavaScriptChannel.postMessage"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiWebViewClient(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiWebViewClient?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.setSynchronousReturnValueForShouldOverrideUrlLoading", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onPageStarted(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, urlArg: String, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.onPageStarted"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun onPageFinished(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, urlArg: String, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.onPageFinished"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_instanceArg, webViewArg, urlArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onReceivedHttpError(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, requestArg: com.tencent.smtt.export.external.interfaces.WebResourceRequest, responseArg: com.tencent.smtt.export.external.interfaces.WebResourceResponse, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.onReceivedHttpError"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun onReceivedRequestError(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, requestArg: com.tencent.smtt.export.external.interfaces.WebResourceRequest, errorArg: com.tencent.smtt.export.external.interfaces.WebResourceError, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.onReceivedRequestError"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun onReceivedRequestErrorCompat(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, requestArg: com.tencent.smtt.export.external.interfaces.WebResourceRequest, errorArg: androidx.webkit.WebResourceErrorCompat, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.onReceivedRequestErrorCompat"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_instanceArg, webViewArg, requestArg, errorArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onReceivedError(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, errorCodeArg: Long, descriptionArg: String, failingUrlArg: String, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.onReceivedError"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun requestLoading(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, requestArg: com.tencent.smtt.export.external.interfaces.WebResourceRequest, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.requestLoading"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun urlLoading(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, urlArg: String, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.urlLoading"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_instanceArg, webViewArg, urlArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun doUpdateVisitedHistory(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, urlArg: String, isReloadArg: Boolean, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.doUpdateVisitedHistory"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun onReceivedHttpAuthRequest(pigeon_instanceArg: com.tencent.smtt.sdk.WebViewClient, webViewArg: com.tencent.smtt.sdk.WebView, handlerArg: com.tencent.smtt.export.external.interfaces.HttpAuthHandler, hostArg: String, realmArg: String, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebViewClient.onReceivedHttpAuthRequest"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiDownloadListener(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiDownloadListener?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.DownloadListener.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
  ...
  fun onDownloadStart(pigeon_instanceArg: com.tencent.smtt.sdk.DownloadListener, urlArg: String, userAgentArg: String, contentDispositionArg: String, mimetypeArg: String, contentLengthArg: Long, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.DownloadListener.onDownloadStart"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiWebChromeClient(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  abstract fun pigeon_defaultConstructor(): io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl
   ...
   * Defaults to false.
   */
  abstract fun setSynchronousReturnValueForOnShowFileChooser(pigeon_instance: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, value: Boolean)
   ...
   * Defaults to false.
   */
  abstract fun setSynchronousReturnValueForOnConsoleMessage(pigeon_instance: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, value: Boolean)
   ...
   * Defaults to false.
   */
  abstract fun setSynchronousReturnValueForOnJsAlert(pigeon_instance: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, value: Boolean)
   ...
   * Defaults to false.
   */
  abstract fun setSynchronousReturnValueForOnJsConfirm(pigeon_instance: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, value: Boolean)
   ...
   * Defaults to false.
   */
  abstract fun setSynchronousReturnValueForOnJsPrompt(pigeon_instance: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, value: Boolean)
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiWebChromeClient?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.setSynchronousReturnValueForOnShowFileChooser", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl
            val valueArg = args[1] as Boolean
            val wrapped: List<Any?> = try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.setSynchronousReturnValueForOnConsoleMessage", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.setSynchronousReturnValueForOnJsAlert", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.setSynchronousReturnValueForOnJsConfirm", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.setSynchronousReturnValueForOnJsPrompt", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl
  ...
  fun pigeon_newInstance(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onProgressChanged(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, webViewArg: com.tencent.smtt.sdk.WebView, progressArg: Long, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onProgressChanged"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun onShowFileChooser(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, webViewArg: com.tencent.smtt.sdk.WebView, paramsArg: com.tencent.smtt.sdk.WebChromeClient.FileChooserParams, callback: (Result<List<String>>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onShowFileChooser"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
   ...
   * or denied.
   */
  fun onPermissionRequest(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, requestArg: com.tencent.smtt.export.external.interfaces.PermissionRequest, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onPermissionRequest"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
  ...
  fun onShowCustomView(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, viewArg: android.view.View, callbackArg: android.webkit.WebChromeClient.CustomViewCallback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onShowCustomView"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
   ...
   * mode.
   */
  fun onHideCustomView(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onHideCustomView"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
   ...
   */
  fun onGeolocationPermissionsShowPrompt(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, originArg: String, callbackArg: android.webkit.GeolocationPermissions.Callback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onGeolocationPermissionsShowPrompt"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
   ...
   * canceled.
   */
  fun onGeolocationPermissionsHidePrompt(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onGeolocationPermissionsHidePrompt"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_instanceArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onConsoleMessage(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, messageArg: com.tencent.smtt.export.external.interfaces.ConsoleMessage, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onConsoleMessage"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_instanceArg, messageArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
   ...
   */
  fun onJsAlert(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, webViewArg: com.tencent.smtt.sdk.WebView, urlArg: String, messageArg: String, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onJsAlert"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
   ...
   */
  fun onJsConfirm(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, webViewArg: com.tencent.smtt.sdk.WebView, urlArg: String, messageArg: String, callback: (Result<Boolean>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onJsConfirm"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_instanceArg, webViewArg, urlArg, messageArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
   ...
   */
  fun onJsPrompt(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.WebChromeClientProxyApi.WebChromeClientImpl, webViewArg: com.tencent.smtt.sdk.WebView, urlArg: String, messageArg: String, defaultValueArg: String, callback: (Result<String?>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebChromeClient.onJsPrompt"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiFlutterAssetManager(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  abstract fun instance(): io.flutter.plugins.webviewflutter.tbs.FlutterAssetManager
   ...
   */
  abstract fun list(pigeon_instance: io.flutter.plugins.webviewflutter.tbs.FlutterAssetManager, path: String): List<String>
   ...
   * absolute path.
   */
  abstract fun getAssetFilePathByName(pigeon_instance: io.flutter.plugins.webviewflutter.tbs.FlutterAssetManager, name: String): String
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiFlutterAssetManager?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.FlutterAssetManager.instance", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.FlutterAssetManager.list", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as io.flutter.plugins.webviewflutter.tbs.FlutterAssetManager
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.FlutterAssetManager.getAssetFilePathByName", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as io.flutter.plugins.webviewflutter.tbs.FlutterAssetManager
  ...
  fun pigeon_newInstance(pigeon_instanceArg: io.flutter.plugins.webviewflutter.tbs.FlutterAssetManager, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.FlutterAssetManager.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
...
abstract class PigeonApiWebStorage(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiWebStorage?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebStorage.instance", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.WebStorage.deleteAllData", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.sdk.WebStorage, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.WebStorage.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.sdk.WebChromeClient.FileChooserParams, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.FileChooserParams.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiPermissionRequest(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiPermissionRequest?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.PermissionRequest.grant", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.PermissionRequest.deny", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.export.external.interfaces.PermissionRequest
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.export.external.interfaces.PermissionRequest, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.PermissionRequest.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiCustomViewCallback(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiCustomViewCallback?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.CustomViewCallback.onCustomViewHidden", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.webkit.WebChromeClient.CustomViewCallback, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.CustomViewCallback.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
...
abstract class PigeonApiView(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiView?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.View.scrollTo", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.View.scrollBy", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as android.view.View
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.View.getScrollPosition", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as android.view.View
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.view.View, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.View.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
...
abstract class PigeonApiGeolocationPermissionsCallback(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiGeolocationPermissionsCallback?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.GeolocationPermissionsCallback.invoke", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.webkit.GeolocationPermissions.Callback, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.GeolocationPermissionsCallback.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
...
abstract class PigeonApiHttpAuthHandler(open val pigeonRegistrar: AndroidWebkitLibraryPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiHttpAuthHandler?) {
      val codec = api?.pigeonRegistrar?.codec ?: AndroidWebkitLibraryPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.HttpAuthHandler.useHttpAuthUsernamePassword", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.HttpAuthHandler.cancel", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.export.external.interfaces.HttpAuthHandler
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android_tbs.HttpAuthHandler.proceed", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as com.tencent.smtt.export.external.interfaces.HttpAuthHandler
  ...
  fun pigeon_newInstance(pigeon_instanceArg: com.tencent.smtt.export.external.interfaces.HttpAuthHandler, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.webview_flutter_android_tbs.HttpAuthHandler.pigeon_newInstance"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_identifierArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
