...
interface AndroidX5WebViewApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: AndroidX5WebViewApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.AndroidX5WebViewApi.initX5Environment$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
